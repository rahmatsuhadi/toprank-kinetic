...
const navItems = [
  ...
  { href: "/mahasiswa/submissions", label: "Pengajuan", icon: FileText },
  { href: "/mahasiswa/leaderboard", label: "Leaderboard", icon: Trophy },
  { href: "/mahasiswa/rewards", label: "Rewards", icon: Gift },
];
    ...
    <div className="flex min-h-screen flex-col lg:flex-row">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-[var(--inverse-surface)] text-[var(--inverse-on-surface)] flex items-center justify-between px-4 z-40 border-b border-white/10">
        ...
        <div className="flex items-center gap-3">
          {userName && <PointChip points={userPoints} size="sm" />}
          <button
            type="button"
