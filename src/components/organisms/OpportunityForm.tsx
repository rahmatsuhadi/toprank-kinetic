...
export function OpportunityForm() {
  ...
  return (
    <form
      action={formAction}
      className="elevation-1 rounded-[var(--rounded-lg)] p-[var(--space-lg)] flex flex-col gap-5"
    >
      ...
      <FormField
        ...
        id="title"
        required
        inputProps={{ placeholder: "Judul opportunity" }}
      />
      <FormField
        label="Deskripsi"
        id="description"
        required
        type="textarea"
        textareaProps={{ placeholder: "Detail opportunity..." }}
      />
      <FormField
        ...
        required
        inputProps={{
          placeholder: "Contoh: React, Node.js, Figma (pisahkan koma)",
        }}
      />
